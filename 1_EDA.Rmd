...
x<-grid.arrange(a,b, nrow=1, widths=c(3,1.3))
x

```

```{r}
ggsave(filename="results_age+bmi.pdf",plot=x, path="~/Desktop/UOC/TFM/R/Figures", width = 6, height = 3.5, dpi = 150, units = "in", device='pdf')
```
